...
pub enum Instruction {
    DataProcessingImmediateShift { s: bool, opcode: OpCode, rn: u8, rd: u8, shift_imm: u8, shift: ShiftType, rm: u8 },
    DataProcessingImmediate {s: bool, opcode: OpCode, rn: u8, rd: u8, rotate: u8, immediate: u8},
    Branch { link: bool, signed_immed_24: u32 },
    MoveImmediateToStatusRegister { r: bool, field_mask: u8, sbo: u8, rotate_imm: u8, immediate: u8 },
    MoveRegisterToStatusRegister { r: bool, field_mask: u8, sbo: u8, sbz: u8, rm: u8 },
    LoadStoreWordOrUnsignedByte_Immediate { p: bool, u: bool, b: bool, w: bool, l: bool, rn: u8, rd: u8, offset_12: u16 },
}
...
pub fn parse_instruction(instr: u32) -> (CondFlags, Instruction) {
    ...
    let op = match opblock {
        ...
        // branches
        0b10100000 ..= 0b10111111 => Branch { link: get_bit(instr, 24), signed_immed_24: get_bits(instr, 0, 24) },
